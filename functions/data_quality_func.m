function data_quality = data_quality_func(sub,ses,project_dir,power_line,age)
restoredefaultpath
close all
clc
...
run = 'run-001';
data_quality.ID = sub;
data_quality.task = 'faces_circles';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
final_good_trls = good_trial_inds(end-remove_trials:end);
vis_artfcts = [vis_artfcts;[trial_info.start(final_good_trls)+100,trial_info.end(final_good_trls)-100]]
...
data_quality.good_trls = sum(endsWith(trial_info.type,'Circles'));
