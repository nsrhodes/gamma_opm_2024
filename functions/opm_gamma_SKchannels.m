function opm_gamma_SKchannels(sub,ses,project_dir,power_line,age)
%5 if running
close all
% sub = '125'
% ses = '001'
...
cd(path_Tstat)
save('dip_loc_vm_SKchans.mat','dip_loc_circles')
dip_loc_circles_mm = dip_loc_circles.*1000;
save([path_Tstat,'circles_peak_vm_SKchans.txt'],'dip_loc_circles_mm','-ascii','-double')
%% get envelope
...
cd(path_TFS)
save(files_TFS,'TFS')
save(files_VEs,'VE_unchopped','ind','trial_time','fs');
%%
